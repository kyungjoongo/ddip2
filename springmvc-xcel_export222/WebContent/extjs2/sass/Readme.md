...
folder are mapped to the application's root namespace, 'extjs2'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'extjs2' in the same way
as `"extjs2/sass/src"`.
